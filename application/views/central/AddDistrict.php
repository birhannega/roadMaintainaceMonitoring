...
<div class="col-lg-5">
    <h3 class="text-capitalize text-info">Add district  </h3>
<?php
...
?>
    <div class="form-group">
        <form class="form-group" method="post" action="<?php echo base_url('index.php/central/Do_addDistrict');?>">
            ...
            <div class="form-group ">
                <label>descriptin of District</label>
    ...
    <div class="col-lg-7">
        <h3 class="text-info">List of registered Districts</h3>
