      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
           ...
           <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" 
                        aria-expanded="false">Resources management<span class="caret"></span></a>
          <ul class="dropdown-menu">
           <li><a href="<?php echo base_url("index.php/central/budget"); ?>">Budget management</a></li>
            <li><a href="<?php echo base_url("index.php/central/machineries"); ?>">machinery management</a></li>
             <li><a href="<?php echo base_url("index.php/central/materials"); ?>">Construction materials</a></li>
          </ul>
        </li>
