...
<div class="table-responsive">
    <table class="table table-bordered table-responsive" id="EmpTable">
                <thead>
                <tr>
                              ...
                              <td class='text-capitalize'>".$object->First_name." ".$object->Middle_name." ".$object->Last_name."</td>
                               <td>".$object->Birth_date."</td>
                                <td>".$object->academic_level."</td>
                                 ...
                                 <button class='btn btn-warning btn-sm'><span class='glyphicon glyphicon-edit'></span></button>
                                  <button class='btn btn-primary btn-sm'><span class='glyphicon glyphicon-eye-open'></span> </button>
                                  </td>   
